...
export function buildLiveSystemPrompt(date = new Date()) {
  ...
  return [
    ...
    'For mixed-language input, follow the language of the user’s final question or command. If the latest meaningful words are Korean, answer in Korean. If they are English, answer in English.',
    ...
    'When teaching English, explain in the language of the user’s latest request. If the user asks in English, teach in English only. If the user asks in Korean, explain in Korean. Only switch languages when the user explicitly asks you to switch. Include at least one easy English example sentence when helpful.',
